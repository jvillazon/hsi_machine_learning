...
def main():
    ...
    base_directory = "/Users/jorgevillazon/Documents/files/integrated_pipeline/HSI_data/data"
    num_samp = 61
    wn_1 = 2700
    wn_2 = 3100
    ...
    visualizer = HSI_Visualizer(
        mol_path='molecule_dataset/averaged_spectra_wn-61.npz',
    ...
    # Generate figure to compare predicted spectra distribution to clean spectra
    spectra_plots_dir = os.path.join(os.path.dirname(base_directory), 'spectra_comparison_plots')
    print("\n" + "=" * 80)
    print("GENERATING SPECTRA COMPARISON PLOTS")
    print("=" * 80)
    visualizer.generate_class_spectra_comparison_plots(
        dataset=dataset,
        prediction_dir=classifier.output_base,
        output_dir=spectra_plots_dir,
        srs_params_path='params_dataset/srs_params_61.npz',
        display_name_map=None,  # Will use display_names dict if defined later
